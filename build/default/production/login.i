...
void login(void)
{
    ...
    if(++wait == 5)
    {
        ...
        if(blink_flag == 1)
        {
            clcd_putch(' ',(0xC0 + blink_pos));
            blink_flag = 0;
        }
        else if(blink_flag == 0)
        {
            clcd_putch(0xFF,(0xC0 + blink_pos));
            blink_flag = 1;
        }
        else
        {
    ...
    if(index > 3)
    {
       ...
       else
       {
           clear_arr(user);
           clear_clcd();
           clcd_print("attempts left ",(0x80 + 0));
           clcd_putch(no_attempt_left+48 ,(0xC0 + 2));
           _delay((unsigned long)((1000)*(20000000/4000.0)));
