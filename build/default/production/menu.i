...
void menu(void)
{
    ...
    scroll_key = read_digital_keypad(0);
    if(scroll_key == 0x37)
    {
        dkp4_press++;
        long_press1 = 0;
    }
    else if(scroll_key == 0x3F && !long_press1)
    {
        long_press1 = 1;
        if(dkp4_press < 20)
        {
    ...
    else if(scroll_key == 0x3F && !long_press2)
    {
        long_press2 = 1;
        if(dkp5_press < 50)
        {
...
static void display_menu(unsigned char *menu[5],unsigned char menu_select)
{
    ...
    {
        clcd_putch('*',(0xC0 + 0));
        clcd_print(menu[menu_select-1],(0x80 + 2));
        clcd_print(menu[menu_select],(0xC0 + 2));
    }
    else
    {
        clcd_putch('*',(0x80 + 0));
        clcd_print(menu[menu_select],(0x80 + 2));
        clcd_print(menu[menu_select+1],(0xC0 + 2));
    }
}
